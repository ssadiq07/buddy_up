...
ActiveRecord::Schema.define(version: 20170530034928) do
  ...
  create_table "preferences", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "My_Formality"
    t.integer  "My_Schedule"
    t.integer  "My_Experience"
    t.integer  "Their_Formality"
    t.integer  "Their_Schedule"
    t.integer  "Their_Experience"
    t.integer  "Wt_Schedule"
    t.integer  "Wt_Formality"
    t.integer  "Wt_Experience"
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
  end
